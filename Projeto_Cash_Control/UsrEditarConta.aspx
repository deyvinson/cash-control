<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageUser.Master" AutoEventWireup="true" CodeBehind="UsrEditarConta.aspx.cs" Inherits="Projeto_Cash_Control.UsrEditarConta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageBody" runat="server">
    ...
    <div class="container" style="max-width: 300px">
        ...
        <div class="form-group">
            <label for="txtSaldo" id="lblSaldo" runat="server">Saldo Inicial (R$):</label>
            <input type="text" class="form-control" id="txtSaldo" runat="server" required>
        </div>
